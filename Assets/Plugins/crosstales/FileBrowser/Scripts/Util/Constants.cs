namespace Crosstales.FB.Util
{
    ...
    public abstract class Constants : Common.Util.BaseConstants
    {
        ...
        public const string ASSET_VERSION = "1.2.1";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 180418;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2018, 4, 18);
